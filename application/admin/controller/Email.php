    ...
    public function mailHeader($msgCount) {  
        ...
        if (strtolower($sender->mailbox) != 'mailer-daemon' && strtolower($sender->mailbox) != 'postmaster') {  
            ...
            $mailHeader = array(  
                ...
                'fromName' =>mb_convert_encoding(imap_mime_header_decode($sender->personal)[0]->text, "UTF-8", "GBK"),  
                'toOther' => strtolower($replyTo->mailbox) . '@' . $replyTo->host,  
                'toOtherName' =>mb_convert_encoding(imap_mime_header_decode($replyTo->personal)[0]->text, "UTF-8", "GBK"),  
                'subject' =>mb_convert_encoding(imap_mime_header_decode($subject)[0]->text, "UTF-8", "GBK"),  
